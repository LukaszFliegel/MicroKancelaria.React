    ...
    return ( 
        <div>
            <Card title="Firms Page" >                
                ...
                <p>Routing:
                    <ul>
                        <li>/Firms - grid with list of entitites</li>
                        <li>/Firm/:id - page with form to edit the entity</li>
                        <li>Addount should be on the rout /Firms, page should just change the "mode"</li>
