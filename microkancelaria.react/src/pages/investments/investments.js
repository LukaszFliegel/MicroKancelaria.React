    ...
    return ( 
        <div>
            <Card title="Investments Page" >                
                ...
                <p>Routing:
                    <ul>
                        <li>/Investments - grid with list of entitites</li>
                        <li>/Investments/:id - page with form to edit the entity</li>
                        <li>Addount should be on the rout /Investments, page should just change the "mode"</li>
                ...
                <p>Additional actions:
                    <ul>
                        <li>Display sell invoices - should go to /reports/SalesRegister</li>
                    </ul>
                </p>
